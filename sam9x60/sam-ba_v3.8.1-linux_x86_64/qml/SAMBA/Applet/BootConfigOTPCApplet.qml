...
BootConfigApplet {
	...
	configParams: [ "BSCR", "BCP-EMUL", "BCP-OTP", "UHCP-EMUL", "UHCP-OTP", "SBCP-EMUL", "SBCP-OTP", "VERS-EMUL", "VERS-OTP" ]
	...
	/*! \internal */
	function readBootCfg(index, option) {
		var value = callReadBootCfg(index, option)
        ...
        case BootCfgOTPC.SBCP_OTP:
            ...
            break;
        case BootCfgOTPC.VERS_EMUL:
        case BootCfgOTPC.VERS_OTP:
            packetLen = versPacketWords * 4
            break;
		}
	...
	function commandLineCommands() {
		return [ "readcfg", "writecfg", "invalidatecfg", "lockpkt", "refreshcfg", "resetemul" ]
	}
